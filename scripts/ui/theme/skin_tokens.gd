...
const COLOR_ERA_04_BACKGROUND := Color("0e1416")
const COLOR_ERA_04_WALL := Color("292f30")
const COLOR_ERA_04_SERVICE := Color("3c3933")
const COLOR_ERA_04_DIM_FLOOR := Color("171d1e")
const COLOR_ERA_04_WARM_FLOOR := Color("4d4639")
const COLOR_ERA_05_BACKGROUND := Color("091114")
const COLOR_ERA_05_BLOCK := Color("242b2b")
const COLOR_ERA_05_STREET := Color("171d20")
const COLOR_ERA_05_DIM_HOME := Color("121719")
