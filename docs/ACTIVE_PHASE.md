...
`docs/phases/PHASE_14_VISUAL_MOBILE_ACCESSIBILITY_QA.md`

## Session instruction

Read `AGENTS.md`, `docs/ROADMAP_V2.md`, the phase contract above, `docs/CURRENT_HANDOFF.md`, `docs/VISUAL_QA_CHECKLIST.md`, `docs/ANDROID_RELEASE_SPEC.md`, `docs/RELEASE_READINESS_DEFINITION.md`, and all Phase 13 evidence before editing. Use `docs/phase_11/cheerful_doomsday/phone_board.png` as the primary visual-composition reference. Preserve the locked Cheerful Electrical Doomsday direction and the human-operator/persistent scratched WATT core rules under `DEC-028`.

Phase 14 is explicitly authorized. Independently audit and correct only the existing production-skinned Eras 1–3 prototype across visual states, supported layouts, accessibility settings, Android interaction/lifecycle behavior, and performance. Preserve the reusable Phase 12/13 systems and locked world-first phone-board composition. Keep `ISSUE-007` explicit: Phase 14 QA must not promote the provisional code-native presentation to final painted-art approval.

Do not integrate generated concept backgrounds as production art, add Era 4, change gameplay/save behavior except a proven QA correction, revise the Phase 11 approval board, perform a major visual-direction change, claim provisional code-native art as the final visual target, begin Phase 15, or modify `ACTIVE_PHASE.md` again without explicit authorization.
