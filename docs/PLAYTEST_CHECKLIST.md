...
Replacement retest artifact: commit `738732d`, Settings build `738732db1f9b`, `build/android/one_more_watt_phase13_debug.apk`, SHA-256 `a26a4521494b2aa6d714abfae1545147e6dbade6ea0df55ea236be10e0e8b8cb`. Static export inspection and the targeted physical retest pass.

Replacement device result:

- [x] Settings build `738732db1f9b` confirmed.
- [x] Build, Upgrades, Reports, and Settings scrolling confirmed working.
- [x] Immediate purchase without a confirmation popup confirmed working.
- [ ] Effective UI line and Android version/API explicitly skipped.
